...
export default (async (connection)=>{
    await execute(connection, `CREATE TABLE "attribute" (
  ...
  CONSTRAINT "ATTRIBUTE_CODE_UUID_UNIQUE" UNIQUE ("uuid")
    ...
    await execute(connection, `CREATE TABLE "attribute_option" (
  ...
  CONSTRAINT "FK_ATTRIBUTE_OPTION" FOREIGN KEY ("attribute_id") REFERENCES "attribute" ("attribute_id") ON DELETE CASCADE
    ...
    await execute(connection, `CREATE INDEX "FK_ATTRIBUTE_OPTION" ON "attribute_option" ("attribute_id")`);
    ...
    await execute(connection, `CREATE TABLE "attribute_group" (
  ...
  CONSTRAINT "ATTRIBUTE_GROUP_UUID_UNIQUE" UNIQUE ("uuid")
    ...
    const defaultGroup = await insert('attribute_group').given({
        group_name: 'Default'
    }).execute(connection);
    await execute(connection, `CREATE TABLE "attribute_group_link" (
  ...
  CONSTRAINT "FK_GROUP_LINK" FOREIGN KEY ("group_id") REFERENCES "attribute_group" ("attribute_group_id") ON DELETE CASCADE
    ...
    await execute(connection, `CREATE INDEX "FK_GROUP_LINK" ON "attribute_group_link" ("group_id")`);
    await execute(connection, `CREATE INDEX "FK_ATTRIBUTE_LINK" ON "attribute_group_link" ("attribute_id")`);
    await insert('attribute_group_link').given({
    ...
    await execute(connection, `CREATE TABLE "variant_group" (
  ...
  CONSTRAINT "FK_ATTRIBUTE_VARIANT_TWO" FOREIGN KEY ("attribute_two") REFERENCES "attribute" ("attribute_id") ON DELETE CASCADE ON UPDATE NO ACTION
    ...
    await execute(connection, `CREATE INDEX "FK_ATTRIBUTE_VARIANT_ONE" ON "variant_group" ("attribute_one")`);
    await execute(connection, `CREATE INDEX "FK_ATTRIBUTE_VARIANT_TWO" ON "variant_group" ("attribute_two")`);
    await execute(connection, `CREATE INDEX "FK_ATTRIBUTE_VARIANT_THREE" ON "variant_group" ("attribute_three")`);
    await execute(connection, `CREATE INDEX "FK_ATTRIBUTE_VARIANT_FOUR" ON "variant_group" ("attribute_four")`);
    await execute(connection, `CREATE INDEX "FK_ATTRIBUTE_VARIANT_FIVE" ON "variant_group" ("attribute_five")`);
    await execute(connection, `CREATE INDEX "FK_ATTRIBUTE_GROUP_VARIANT" ON "variant_group" ("attribute_group_id")`);
    await execute(connection, `CREATE TABLE "product" (
  ...
  CONSTRAINT "FK_PRODUCT_VARIANT_GROUP" FOREIGN KEY ("variant_group_id") REFERENCES "variant_group" ("variant_group_id") ON DELETE SET NULL
    ...
    await execute(connection, `CREATE INDEX "FK_PRODUCT_ATTRIBUTE_GROUP" ON "product" ("group_id")`);
    await execute(connection, `CREATE INDEX "FK_PRODUCT_VARIANT_GROUP" ON "product" ("variant_group_id")`);
    await execute(connection, `CREATE TABLE "product_attribute_value_index" (
  ...
  CONSTRAINT "FK_PRODUCT_ATTRIBUTE_LINK" FOREIGN KEY ("product_id") REFERENCES "product" ("product_id") ON DELETE CASCADE
    ...
    await execute(connection, `CREATE INDEX "FK_ATTRIBUTE_VALUE_LINK" ON "product_attribute_value_index" ("attribute_id")`);
    await execute(connection, `CREATE INDEX "FK_ATTRIBUTE_OPTION_VALUE_LINK" ON "product_attribute_value_index" ("option_id")`);
    await execute(connection, `CREATE INDEX "FK_PRODUCT_ATTRIBUTE_LINK" ON "product_attribute_value_index" ("product_id")`);
    await execute(connection, `CREATE TABLE "product_custom_option" (
  ...
  CONSTRAINT "FK_PRODUCT_CUSTOM_OPTION" FOREIGN KEY ("product_custom_option_product_id") REFERENCES "product" ("product_id") ON DELETE CASCADE
    ...
    await execute(connection, `CREATE INDEX "FK_PRODUCT_CUSTOM_OPTION" ON "product_custom_option" ("product_custom_option_product_id")`);
    await execute(connection, `CREATE TABLE "product_custom_option_value" (
  ...
  CONSTRAINT "FK_CUSTOM_OPTION_VALUE" FOREIGN KEY ("option_id") REFERENCES "product_custom_option" ("product_custom_option_id") ON DELETE CASCADE
    ...
    await execute(connection, `CREATE INDEX "FK_CUSTOM_OPTION_VALUE" ON "product_custom_option_value" ("option_id")`);
    await execute(connection, `CREATE TABLE "product_description" (
  ...
  CONSTRAINT "FK_PRODUCT_DESCRIPTION" FOREIGN KEY ("product_description_product_id") REFERENCES "product" ("product_id") ON DELETE CASCADE
    ...
    await execute(connection, `CREATE INDEX "FK_PRODUCT_DESCRIPTION" ON "product_description" ("product_description_product_id")`);
    await execute(connection, `CREATE TABLE "product_image" (
  ...
  CONSTRAINT "FK_PRODUCT_IMAGE_LINK" FOREIGN KEY ("product_image_product_id") REFERENCES "product" ("product_id") ON DELETE CASCADE
    ...
    await execute(connection, `CREATE INDEX "FK_PRODUCT_IMAGE_LINK" ON "product_image" ("product_image_product_id")`);
    await execute(connection, `CREATE TABLE "category" (
  ...
  "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
   CONSTRAINT "CATEGORY_UUID_UNIQUE" UNIQUE ("uuid")
    ...
    await execute(connection, `CREATE TABLE "product_category" (
  ...
  CONSTRAINT "FK_PRODUCT_CATEGORY_LINK" FOREIGN KEY ("product_id") REFERENCES "product" ("product_id") ON DELETE CASCADE
    ...
    await execute(connection, `CREATE INDEX "FK_CATEGORY_PRODUCT_LINK" ON "product_category" ("category_id")`);
    await execute(connection, `CREATE INDEX "FK_PRODUCT_CATEGORY_LINK" ON "product_category" ("product_id")`);
    await execute(connection, `CREATE TABLE "category_description" (
  ...
  CONSTRAINT "FK_CATEGORY_DESCRIPTION" FOREIGN KEY ("category_description_category_id") REFERENCES "category" ("category_id") ON DELETE CASCADE
    ...
    await execute(connection, `CREATE INDEX "FK_CATEGORY_DESCRIPTION" ON "category_description" ("category_description_category_id")`);
    // COLLECTION
    await execute(connection, `CREATE TABLE "collection" (
  ...
  CONSTRAINT "COLLECTION_UUID_UNIQUE" UNIQUE ("uuid")
    ...
    await execute(connection, `CREATE TABLE "product_collection" (
  ...
  CONSTRAINT "FK_PRODUCT_COLLECTION_LINK" FOREIGN KEY ("product_id") REFERENCES "product" ("product_id") ON DELETE CASCADE
    ...
    await execute(connection, `CREATE INDEX "FK_COLLECTION_PRODUCT_LINK" ON "product_collection" ("collection_id")`);
    await execute(connection, `CREATE INDEX "FK_PRODUCT_COLLECTION_LINK" ON "product_collection" ("product_id")`);
    /* CREATE SOME TRIGGERS */ // Prevent deleting a default attribute group
    await execute(connection, `CREATE OR REPLACE FUNCTION prevent_delete_default_attribute_group()
        RETURNS TRIGGER
        LANGUAGE PLPGSQL
        AS
      $$
      ...
      END;
      $$`);
    await execute(connection, `CREATE TRIGGER "PREVENT_DELETING_THE_DEFAULT_ATTRIBUTE_GROUP"
    ...
    await execute(connection, `CREATE OR REPLACE FUNCTION prevent_change_attribute_group()
        RETURNS TRIGGER
        LANGUAGE PLPGSQL
        AS
      $$
      ...
      END;
      $$`);
    await execute(connection, `CREATE TRIGGER "PREVENT_CHANGING_ATTRIBUTE_GROUP_OF_PRODUCT_WITH_VARIANTS"
    ...
    await execute(connection, `CREATE OR REPLACE FUNCTION remove_attribute_from_group()
        RETURNS TRIGGER 
        LANGUAGE PLPGSQL
        AS
      $$
      ...
      END;
      $$;`);
    await execute(connection, `CREATE TRIGGER "TRIGGER_AFTER_REMOVE_ATTRIBUTE_FROM_GROUP" AFTER DELETE ON "attribute_group_link"
     FOR EACH ROW 
     EXECUTE PROCEDURE remove_attribute_from_group();
    `);
    //  Update product attribute value option text when option is updated
    await execute(connection, `CREATE OR REPLACE FUNCTION update_product_attribute_option_value_text()
        RETURNS TRIGGER 
        LANGUAGE PLPGSQL
        AS
      $$
      ...
      END;
      $$;`);
    await execute(connection, `CREATE TRIGGER "TRIGGER_AFTER_ATTRIBUTE_OPTION_UPDATE" AFTER UPDATE ON "attribute_option" FOR EACH ROW
    EXECUTE PROCEDURE update_product_attribute_option_value_text();
    `);
    //  Delete product attribute value index after option is deleted
    await execute(connection, `CREATE OR REPLACE FUNCTION delete_product_attribute_value_index()
        RETURNS TRIGGER 
        LANGUAGE PLPGSQL
        AS
      $$
      ...
      END;
      $$;`);
    await execute(connection, `CREATE TRIGGER "TRIGGER_AFTER_DELETE_ATTRIBUTE_OPTION" AFTER DELETE ON "attribute_option" FOR EACH ROW
    EXECUTE PROCEDURE delete_product_attribute_value_index();
    `);
    // Update variant group visibility after new product is added
    await execute(connection, `CREATE OR REPLACE FUNCTION update_variant_group_visibility()
        RETURNS TRIGGER 
        LANGUAGE PLPGSQL
        AS
      $$
      ...
      END;
      $$;`);
    await execute(connection, `CREATE CONSTRAINT TRIGGER "TRIGGER_AFTER_INSERT_PRODUCT" AFTER INSERT ON "product" 
    ...
    await execute(connection, `CREATE OR REPLACE FUNCTION update_attribute_index_and_variant_group_visibility()
        RETURNS TRIGGER 
        LANGUAGE PLPGSQL
        AS
      $$
      ...
      END;
      $$;`);
    await execute(connection, `CREATE CONSTRAINT TRIGGER "TRIGGER_PRODUCT_AFTER_UPDATE" AFTER UPDATE ON "product"
    ...
    await execute(connection, `CREATE OR REPLACE FUNCTION delete_variant_group_after_attribute_type_changed()
        RETURNS TRIGGER 
        LANGUAGE PLPGSQL
        AS
      $$
      ...
      END
      $$;`);
    await execute(connection, `CREATE TRIGGER "TRIGGER_AFTER_UPDATE_ATTRIBUTE" AFTER UPDATE ON "attribute" FOR EACH ROW
